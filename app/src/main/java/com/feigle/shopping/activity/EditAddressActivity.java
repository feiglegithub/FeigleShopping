...
public class EditAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData(intent.getStringExtra("contact"), intent.getStringExtra("phone"), intent.getStringExtra("address"),
                intent.getStringExtra("def"));
    }
    ...
    private void initData(String contact, String phone, String address, String def) {
        contactEditText.setText(contact);
        phoneEditText.setText(phone);
        addressEditText.setText(address);
        defSwitch.setChecked(def.equals("0") ? false : true);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.commitButton:
                ...
                String def = defSwitch.isChecked() ? "1" : "0";
                ...
                new UpdateAddressAsyncTask().execute(HttpUtils.SERVLET_UPDATE_ADDRESS_REQUEST, id, contact, phone, address, def);
                break;
            default:
                break;
        }
    ...
    class UpdateAddressAsyncTask extends AsyncTask<String, Integer, Map> {
        ...
        protected Map doInBackground(String... strings) {
            ...
            try {
                ...
                jsonObject.put("contact", strings[2]);
                jsonObject.put("phone", strings[3]);
                jsonObject.put("address", strings[4]);
                jsonObject.put("def", strings[5]);
