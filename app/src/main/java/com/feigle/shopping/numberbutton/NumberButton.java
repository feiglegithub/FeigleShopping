...
package com.feigle.shopping.numberbutton;
...
//    }
        ...
        if (id == R.id.button_sub) {
            if (count > 1) {
                ...
                if (mOnNumberChangedListener != null)
                    mOnNumberChangedListener.onNumberChanger(count - 1);
            }
    ...
    private void onNumberInput() {
        ...
        if (mOnNumberChangedListener != null) mOnNumberChangedListener.onNumberChanger(count);
    }
    ...
    public NumberButton setOnNumberChangedListener(OnNumberChangedListener mOnNumberChangedListener) {
    ...
    public void setEnabled(boolean enabled) {
        ...
        mCount.setEnabled(enabled);
        if (enabled) {
            subButton.setBackgroundColor(0);
            addButton.setBackgroundColor(0);
            mCount.setBackgroundColor(0);
        } else {
            subButton.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
            addButton.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
            mCount.setBackgroundColor(getResources().getColor(android.R.color.darker_gray));
        }
    }
    ...
    public interface OnNumberChangedListener {
        void onNumberChanger(int number);
    }
}
